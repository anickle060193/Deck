...
export interface MoveCardsAction extends Action
{
  type: CardActions.MoveCards;
  gameId: string;
  cardIds: string[];
  xOffset: number;
  yOffset: number;
...
export const moveCards = ( gameId: string, cardIds: string[], xOffset: number, yOffset: number ): MoveCardsAction => ( {
  type: CardActions.MoveCards,
  gameId,
  cardIds,
  xOffset,
